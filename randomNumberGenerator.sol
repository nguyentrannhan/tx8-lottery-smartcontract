...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
     ...
     * @param _seed: seed provided by the TX8 lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == tx8Lottery, "Only tx8Lottery");
    ...
    /**
     * @notice Set the address for the tx8Lottery
     * @param _tx8Lottery: address of the TX8 lottery
     */
    function setLotteryAddress(address _tx8Lottery) external onlyOwner {
        tx8Lottery = _tx8Lottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = ITX8Lottery(tx8Lottery).viewCurrentLotteryId();
    }
}